...
describe 'spree/addresses/new' do
  ...
  it 'renders new.html.erb for new address' do
    ...
    rendered.should have_field(Spree.t('activerecord.attributes.spree/address.address1'), :type => 'text')
    rendered.should have_field(Spree.t('activerecord.attributes.spree/address.address2'), :type => 'text')
...
describe 'spree/addresses/edit' do
  ...
  it 'renders edit.html.erb for editing an existing address' do
    ...
    rendered.should have_field(Spree.t('activerecord.attributes.spree/address.address1'), :with => address.address1, :type => 'text')
    rendered.should have_field(Spree.t('activerecord.attributes.spree/address.address2'), :with => address.address2, :type => 'text')
    # Javascript can't be tested in views spec
    rendered.should have_selector('select#address_country_id', :type => 'text')
    # Javascript can't be tested in views spec
    rendered.should have_selector('#address_state_name', :type => 'text')
